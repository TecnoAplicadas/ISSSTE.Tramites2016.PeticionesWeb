...
using ISSSTE.TramitesDigitales2016.PeticionesWeb.Rdn.Modulos.Usuarios;
...
namespace ISSSTE.TramitesDigitales2016.PeticionesWeb.Presentacion.Controllers
{
    ...
    public class AccountController : BaseController
    {
        ...
        public string ConvierteListaACadena( List<string> ListaNuemrica)
        {
            string ListacadenaSP = "";
            foreach (string item in ListaNuemrica)
            {
                if (ListacadenaSP != "")
                    ListacadenaSP = ListacadenaSP + "," + item.ToString();
                else
                    ListacadenaSP = ListacadenaSP + item.ToString();
            }

            return ListacadenaSP;
        }
