...
namespace ISSSTE.TramitesDigitales2016.PeticionesWeb.Procesos.Modulos.Catalogos
{
    ...
    {
        public List<pa_PeticionesWeb_Catalogos_Obtener_Municipios_Result> ObtenerMunicipio(clsMunicipio pEntrada, ErrorProcedimientoAlmacenado pError)
        {
            ...
            try
            {
                ...
                {
                    respuestaWeb = Db.pa_PeticionesWeb_Catalogos_Obtener_Municipios(
                        idEstado: pEntrada.IdEstado,
        ...
        public List<pa_PeticionesWeb_Catalogos_Obtener_MunicipioByCodigoPostal_Result> ObtenerMunicipioCP(clsCodigoPostal pEntrada, ErrorProcedimientoAlmacenado pError)
        {
            ...
            try
            {
                using (var Db = new TramitesDigitalesEntities())
                {
                    respuestaWeb = Db.pa_PeticionesWeb_Catalogos_Obtener_MunicipioByCodigoPostal(
