...
{
    public class CatalogoUnidadAdministrativa
    {
        public List<pa_PeticionesWeb_Catalogos_Obtener_UndadesAdministrativas_Result> ObtenerUnidadAdministrativa(clsUnidadAdministrativa pEntrada, ErrorProcedimientoAlmacenado pError)
        {
            ...
            try
            {
                ...
                {
                    respuestaWeb = Db.pa_PeticionesWeb_Catalogos_Obtener_UndadesAdministrativas(
