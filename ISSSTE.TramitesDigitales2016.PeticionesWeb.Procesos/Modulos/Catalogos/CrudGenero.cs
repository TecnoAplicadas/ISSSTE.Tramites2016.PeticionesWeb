...
namespace ISSSTE.TramitesDigitales2016.PeticionesWeb.Procesos.Modulos.Catalogos
{
   ...
   {
      public List<pa_PeticionesWeb_Catalogos_Obtener_Generos_Result> obtenerGeneros(Genero pEntrada, ErrorProcedimientoAlmacenado pError)
      {
         ...
         try
         {
            ...
            {
               respuestaWeb = Db.pa_PeticionesWeb_Catalogos_Obtener_Generos(
               pi_id_genero: pEntrada.IdGenero,
